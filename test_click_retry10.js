...
async function run() {
  ...
  console.log('Clicking Retry via pure page.evaluate from global document');
      
  await page.evaluate(() => {
    const btns = Array.from(document.querySelectorAll('button'));
    const retryBtn = btns.find(b => b.innerText.includes('재도전') && b.offsetParent !== null);
    if(retryBtn) { 
